...
libcuhook.so: wrapcuda.cpp wrapcublas.cpp common.c wraputil.cpp mid_queue.c
	$(CXX) -I$(CUDAPATH)/include -o libcuhook.so wrapcuda.cpp wrapcublas.cpp common.c mid_queue.c wraputil.cpp $(SHAREDFLAGS)
