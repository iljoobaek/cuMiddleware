...
int ConvertIplToTexturePX2_1(IplImage *image, GLuint *texture)
{
	glGenTextures(1,texture);
	glBindTexture(GL_TEXTURE_2D,*texture);
...
int ConvertIplToTexturePX2_2(IplImage *image)
{
	//printf("target_im_width = %d, target_im_height = %d\n", target_im->width, target_im->height);
	glTexImage2D(GL_TEXTURE_2D, 0,GL_RGB, image->width, image->height, 0, GL_BGR, GL_UNSIGNED_BYTE, image->imageData);
	// ... nice trilinear filtering ...
...
int ConvertIplToTexturePX2_3(IplImage *image)
{
	// ... which requires mipmaps. Generate them automatically.
	glGenerateMipmap(GL_TEXTURE_2D);
...
auto tagged_work1_ptr = frame_job_decorator(ConvertIplToTexturePX2_1, &fc, "ConvertIplToTexturePX2_1", true);
auto tagged_work2_ptr = frame_job_decorator(ConvertIplToTexturePX2_2, &fc, "ConvertIplToTexturePX2_2", true);
auto tagged_work3_ptr = frame_job_decorator(ConvertIplToTexturePX2_3, &fc, "ConvertIplToTexturePX2_3", true);
auto tagged_work4_ptr = frame_job_decorator(ConvertIplToTexturePX2_4, &fc, "ConvertIplToTexturePX2_4", true);
auto tagged_work5_ptr = frame_job_decorator(ConvertIplToTexturePX2_5, &fc, "ConvertIplToTexturePX2_5", true);
auto tagged_work6_ptr = frame_job_decorator(ConvertIplToTexturePX2_6, &fc, "ConvertIplToTexturePX2_6", true);
auto tagged_work7_ptr = frame_job_decorator(ConvertIplToTexturePX2_7, &fc, "ConvertIplToTexturePX2_7", true);
auto tagged_work8_ptr = frame_job_decorator(ConvertIplToTexturePX2_8, &fc, "ConvertIplToTexturePX2_8", true);
auto tagged_work9_ptr = frame_job_decorator(ConvertIplToTexturePX2_9, &fc, "ConvertIplToTexturePX2_9", true);
auto tagged_work10_ptr = frame_job_decorator(ConvertIplToTexturePX2_10, &fc, "ConvertIplToTexturePX2_10", true);
auto tagged_work11_ptr = frame_job_decorator(ConvertIplToTexturePX2_11, &fc, "ConvertIplToTexturePX2_11", true);
auto tagged_work12_ptr = frame_job_decorator(ConvertIplToTexturePX2_12, &fc, "ConvertIplToTexturePX2_12", true);
