...
//			printf("%f ms/frame\n", 1000.0/double(nbFrames));
		...
		gGpuLog.WriteLogs(timeLog.GetTimeDiff(), "Draw1", 4);	// Diff(GL Buffer Setup, Draw Half)
		...
		gGpuLog.WriteLogs(timeLog.GetTimeDiff(), "Draw2", 4);	// Diff(Draw Half, Draw Full)
		...
		gGpuLog.WriteLogs(timeLog.GetTimeDiff(), "SwapEnd", 4);	// Diff(Draw Full, Swap and End of Frame)
